...
- `scripts/strategies/gradient/compute_signals.py`
- `scripts/strategies/gradient/run_backtest.py`

Expose CLI entry points via `pyproject.toml`, e.g.:

```
[project.scripts]
gradient-signals = "slipstream.strategies.gradient.scripts:compute_signals_cli"
gradient-backtest = "slipstream.strategies.gradient.scripts:run_backtest_cli"
```
...
- Add `docs/strategies/gradient/README.md` covering concept, workflow, commands, and configuration.
